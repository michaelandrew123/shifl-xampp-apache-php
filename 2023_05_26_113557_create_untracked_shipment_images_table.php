...
class CreateUntrackedShipmentImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('untracked_shipment_images', function (Blueprint $table) {
            $table->id();
...
//            $table->text('position')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('untracked_shipment_images');
